...
require 'cielo/api30/reply_data'
require 'cielo/api30/recurrent_payment'
require 'cielo/api30/fraud_analysis_shipping'
require 'cielo/api30/fraud_analysis'
require 'cielo/api30/merchant_defined_fields'
require 'cielo/api30/cart_item'
require 'cielo/api30/cart'
